...
file_permissions=(
  ...
  ["/usr/local/bin/harbor-runner-bootstrap"]="0:0:750"
  ["/usr/local/bin/harbor-compose-up"]="0:0:750"
  ["/usr/local/bin/harbor-compose-down"]="0:0:750"
  ["/usr/local/bin/harbor-compose-update"]="0:0:750"
  ["/usr/local/sbin/harbor-deploy"]="0:0:750"
